...
def vector_field(n):
    img1 = cv2.imread("Ball/ball-{}.png".format(n), 0)
    img2 = cv2.imread("Ball/ball-{}.png".format(n+1), 0)
    ...
    img = cv2.imread("Ball/ball-{}.png".format(n))
    ...
    cv2.imwrite('Ball/test-{}.png'.format(n), img)
